...
const handleSubmit = async (e) => {
  ...
  return (
    <Layout>
      <div className="lg:max-w-4xl lg:py-5 px-20 mx-auto lg:flex  justify-cente items-center lg:gap-4 lg:justify-around lg:shadow-2xl border-r-1 lg:max-h-[200vh] lg:border-2 border-zinc-100 rounded-lg">
