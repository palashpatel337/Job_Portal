...
const handleSubmit = async (e) => {
  ...
  return (
    <Layout>
      <div className="lg:max-w-4xl lg:py-[20px] lg:my-[100px] px-20 mx-auto lg:flex  justify-cente items-center lg:gap-4 lg:justify-around lg:shadow-2xl border-r-1 lg:max-h-[200vh] lg:border-1 border-zinc-200 rounded-lg">
