...
function JobApplicants() {
  ...
  const ApplicantSkeleton = () => {
    return (
      ...
      >
        ...
        {/* CENTER */}
        <div className="w-full md:w-[40%] space-y-2 border-t md:border-t-0 md:border-l border-white/10 md:pl-6 pt-4 md:pt-0">
        ...
        <div className="flex flex-col md:items-end gap-4 w-full md:w-[25%]">
          ...
          <Skeleton className="h-10 w-full md:w-40 rounded-xl bg-white/10" />
        </div>
      </div>
    );
  };
  ...
  return (
    <div
      className="min-h-screen relative overflow-hidden sm:px-8 lg:pl-16 lg:pr-28 py-14"
      style={{
        background:
              ...
              >
                ...
                <div className="flex  md:items-end gap-4 w-full md:w-[25%]">
                  ...
                  <select
                    ...
                    className="px-4 py-2 rounded-xl border bg-transparent text-white text-sm outline-none w-full md:w-auto"
                    style={{
                      borderColor: "rgba(196,181,253,0.2)",
                    }}
                  >
