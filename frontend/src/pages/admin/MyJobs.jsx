...
//       }}
//     >
//       <div className="relative overflow-hidden min-h-screen py-10 ">
//         {/* Glow Orbs */}
//         <div
...
function MyJobs() {
  ...
  const JobCardSkeleton = () => {
    return (
      <div
        className="rounded-2xl lg:w-[18vw] border backdrop-blur-xl p-6 shadow-lg"
        style={{
          background: "rgba(255,255,255,0.04)",
          borderColor: "rgba(196,181,253,0.15)",
        }}
      >
        <Skeleton className="h-6 w-[80%] mb-3 bg-white/10" />
        <Skeleton className="h-4 w-[60%] mb-6 bg-white/10" />
        ...
        <div className="space-y-3">
          ...
          <Skeleton className="h-4 w-[65%] bg-white/10" />
        </div>

        <div className="my-5 h-[1px] w-full bg-white/10" />

        <Skeleton className="h-4 w-[50%] mb-2 bg-white/10" />
        <Skeleton className="h-4 w-full mb-2 bg-white/10" />
        <Skeleton className="h-4 w-[90%] mb-4 bg-white/10" />

        <Skeleton className="h-4 w-[50%] mb-2 bg-white/10" />
        <Skeleton className="h-4 w-full mb-2 bg-white/10" />
        <Skeleton className="h-4 w-[85%] mb-6 bg-white/10" />
  ...
  return (
    <div
      className="min-h-screen relative overflow-hidden lg:pl-16 py-12 mr-24 pr-8"
      style={{
        background:
          "linear-gradient(135deg, #0D0A1A 0%, #1E1333 40%, #2D1B5E 70%, #3B1F7A 100%)",
      }}
