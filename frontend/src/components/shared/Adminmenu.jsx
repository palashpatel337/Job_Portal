...
//     <Sidebar
//       collapsible="icon"
//       className="border-r-0 mt-20 !bg-transparent backdrop-blur-md w-[20vw] fixed left-0 top-0 h-screen z-50"
//       style={{
...
export default function AdminMenu() {
  ...
  return (
    ...
    >
      ...
      {/* Divider */}
      <div className="mx-4 h-px" style={{ background: "rgba(196,181,253,0.1)" }} />
      ...
      <SidebarFooter className="px-2 pb-4">
        ...
        {/* Divider */}
        <div className="mx-1 my-3 h-px" style={{ background: "rgba(196,181,253,0.08)" }} />

        {/* User row */}
        <div className="flex items-center gap-3 px-3 py-2">
          <Avatar className="h-8 w-8 shrink-0 ring-2 ring-purple-500/30">
            <AvatarFallback
              className="text-xs font-semibold text-white"
              style={{ background: "linear-gradient(135deg, #7C3AED, #9D5CF6)" }}
            >
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">Jane Doe</p>
              <p className="text-xs truncate" style={{ color: "rgba(196,181,253,0.4)" }}>
                Recruiter
              </p>
            </div>
          )}
